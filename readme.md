...
**Try 2.0 RC3:** [2.0.0-rc.3 release notes and installation](https://github.com/mizorewww/course2md/releases/tag/v2.0.0-rc.3). Use the `course2md-gui@rc` Homebrew cask; the default installation options below provide the stable release.
